// Bookmarklet code as exportable constant
// This allows the worker to serve it as a static JavaScript file

export const BOOKMARKLET_CODE = `// Wishlist Widget Bookmarklet
